...
public class GridPanel extends JPanel{
    ...
    public void clickPixel(int mouseX, int mouseY) {
        ...
        //    of the pixel that was clicked. *HINT* Use the pixel's dimensions.
    		int clickedPixelX = mouseX/pixelWidth;
    		int clickedPixelY = mouseY/pixelHeight;
    		
    		pixels[clickedPixelX][clickedPixelY].color = color;
    		
    		System.out.println("Clicked Pixel X+Y: " + clickedPixelX + ", " + clickedPixelY);
